...
namespace mystl{
    namespace test{
        namespace queue_test{
            ...
            void queue_print(mystl::queue<T, Container> q)
            {
                while (!q.empty())
                {
                    std::cout << " " << q.front();
...
#define P_QUEUE_FUN_AFTER(con, fun) do {         \
  ...
  P_QUEUE_COUT(con);                             \
            ...
            void queue_test()
            {
                ...
                int a[] = { 1,2,3,4,5 };
                Container d1(5);
                mystl::queue<T, Container> q1;
                mystl::queue<T, Container> q2(5);
                mystl::queue<T, Container> q3(5, 1);
                mystl::queue<T, Container> q4(a, a + 5);
                mystl::queue<T, Container> q5(d1);
                mystl::queue<T, Container> q6(std::move(d1));
                mystl::queue<T, Container> q7(q2);
                mystl::queue<T, Container> q8(std::move(q2));
                mystl::queue<T, Container> q9;
                q9 = q3;
                mystl::queue<T, Container> q10;
                q10 = std::move(q3);
                mystl::queue<T, Container> q11{ 1,2,3,4,5 };
                mystl::queue<T, Container> q12;
                q12 = { 1,2,3,4,5 };
